<template>
    <footer class="fly-search-footer">
             ...
             <div class="fly-search-links-container">
               <div class="fly-search132">
                 <div class="fly-search-product-container">
                   ...
                   <span class="home-text094">Package</span>
                   <span>Visa</span>
                 </div>
                 <div class="home-company-container">
                   <span class="home-text096">Company</span>
                   <span class="home-text097">About</span>
                   <span class="home-text098">Careers</span>
                   <span class="home-text099">Contact</span>
                   <span>Blog</span>
                 </div>
               </div>
               <div class="fly-search133">
                 ...
                 <div class="home-socials">
                   <span class="home-text108">Follow Us</span>
           ...
           <span class="home-text109">
             © 2024 "FLY4ALL" All Rights Reserved.
           </span>
         </footer>
</template>
<style scoped>
